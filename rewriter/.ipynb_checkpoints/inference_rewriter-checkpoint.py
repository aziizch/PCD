...
def inference_LLM_patch(prompt_path):
    ...
    pretrained_path = r'C:\Users\clouduser\Desktop\CodeFuse-cgm\CodeFuse-CGM-main\Qwen'
    ...
    test_basic_info.to_json("CodeFuse-CGM/rewriter/test_rewriter_output.json", index=False)
